...
header = function(formattedAddress) {
  return console.log(formattedAddress.bold);
};
...
displayDaily = function(daily, hourly, minutely) {
...
exports.get = function(place, hourly) {
  ...
  return geocoder.geocode(place, function(err, data) {
    ...
    if (location = address != null ? (ref1 = address.geometry) != null ? ref1.location : void 0 : void 0) {
      return client.get(location.lat + "," + location.lng + "?units=" + (defaults.units()) + "&exclude=alerts", function(err, res, body) {
        if (err) {
          ...
          if (hourly) {
            ...
            return displayDaily(body != null ? body.daily : void 0, body != null ? body.hourly : void 0, body != null ? body.minutely : void 0);
          }
        }
      });
    } else {
